...
object GameData {
    var games: Array<GameBank> = arrayOf(
        ...
        GameBank(
            ...
            R.drawable.banner_ml
        ),
        GameBank(
            "Dota 2",
            "Dota 2 is a multiplayer online battle arena (MOBA) video game in which two teams of five players compete to destroy a large structure defended by the opposing team known as the \"Ancient\" whilst defending their own. As in Defense of the Ancients, the game is controlled using standard real-time strategy controls, and is presented on a single map in a three-dimensional isometric perspective. Ten players each control one of the game's 125 playable characters, known as \"heroes\", with each having their own design, strengths, and weaknesses.[1][2][4] Heroes are divided into two primary roles, known as the core and support.",
            R.drawable.banner_dota
        )
    )
}